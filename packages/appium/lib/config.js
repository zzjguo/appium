...
import { SERVER_TYPE, PLUGIN_TYPE, DRIVER_TYPE } from './extension-config';
...
function getNonDefaultServerArgs (parser, args) {
  ...
  const defaultsFromSchema = {
    ...getDefaultsFromSchema({exclude: [SERVER_TYPE, PLUGIN_TYPE, DRIVER_TYPE]}),
...
function validateServerArgs (parser, args) {
  ...
  const nonDefaultArgs = getNonDefaultServerArgs(parser, args);
